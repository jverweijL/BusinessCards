...
public interface businesscardLocalService extends BaseLocalService,
	...
	*/
    ...
    businesscard addbusinesscard(businesscard businesscard);
	...
	*/
    businesscard createbusinesscard(long businesscardId);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
    businesscard deletebusinesscard(long businesscardId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    businesscard fetchbusinesscard(long businesscardId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    businesscard getbusinesscard(long businesscardId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
    businesscard updatebusinesscard(businesscard businesscard);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    List<businesscard> getbusinesscards(int start, int end);
	...
	*/
	...
	void saveBusinesscard(java.lang.String name,
